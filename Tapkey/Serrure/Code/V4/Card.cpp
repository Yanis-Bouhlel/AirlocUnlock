...
void Card::setup(int ledPin, int motorPin1, int motorPin2, int motorPin3, int motorPin4, int lectorPin)
{
    ...
    mesBroches->Support(123456789, 'M2', motorPin2);
    mesBroches->Support(123456789, 'M3', motorPin3);
    mesBroches->Support(123456789, 'M4', motorPin4);
    mesBroches->Support(123456789, 'W', lectorPin);
    
    myMotor->setup(50, 4, motorPin1, motorPin2, motorPin3, motorPin4);
